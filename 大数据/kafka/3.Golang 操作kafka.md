...
# 创建topic
./kafka-topics.sh --create --bootstrap-server 10.0.23.106:9092  --replication-factor 1 --partitions 3 --topic SENSOR_DB.KPXXB_HZB_SPLIT
...
./kafka-consumer-groups.sh --bootstrap-server :9092 --group test-consumer-group --describe
